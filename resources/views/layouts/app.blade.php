...
<head>
    ...
    <link rel="shortcut icon"
        href="{{ $app ? config('app.url') . 'storage/' . $app->favicon_path : config('app.url') . 'images/fevicon.ico.png' }} "
        type="image/x-icon" />
            ...
            <div class="container">
                ...
                <div class="row">
                        ...
                        <div class="header-info">
                            ...
                            <div class="info-inner">
                                ...
                                <span class="iconcont"><a data-scroll href="#">Daily:
                                        {{ $app ? $app->working_horse : '7:00 AM - 8:00 PM' }}</a>
                                </span>
                    ...
                    @if (!is_null(auth()->user()))
                        <form action="{{ url('logout') }}" style="margin-left: 124%;"
                            method="post">
                            @csrf
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="logo padding">
                        <a href="{{ url('/') }}"><img
                                src="{{ $app ? 'storage/' . $app->logo_path : config('app.url') . 'images/logo.png' }}"
                                alt=""></a>
