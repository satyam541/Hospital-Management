        ...
        <div class="container">
            ...
            <div class="box box-primary" >
                <div class="box-body">
                    ...
                    <div class="text-capitalize bg-dark p-2 shadow mb-3 text-center text-lg text-light rounded" >Add New Patient</div>
                    ...
                    <div class="text-capitalize bg-dark p-2 shadow mb-3 text-center text-lg text-light rounded" >All  patients</div>
                    <table width="100%" class="table table-hover"   id="">
                        ...
                        <tbody>
                            ...
                            @empty
                            <td colspan="9" class="text-warning">No data available</td>
                        </tr>
                            @endforelse
                            </tbody>
                    </table>
