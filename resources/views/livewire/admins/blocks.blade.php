        ...
        <div class="container">
            ...
            <div class="box box-primary" >
                <div class="box-body">
                    ...
                    <div class="text-capitalize bg-dark p-2 shadow mb-3 text-center text-lg text-light rounded" >Add New block</div>
                    ...
                    <div class="text-capitalize bg-dark p-2 shadow mb-3 text-center text-lg text-light rounded" >All  Blocks</div>
                    <table  class="table table-hover"  style="" id="">
                        ...
                        <tbody>
                            ...
                            @empty
                            <td class="text-warning" colspan="5">Null</td>
                        </tr>
                            @endforelse
                            </tbody>
                    </table>
