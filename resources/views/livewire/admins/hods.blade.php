        ...
        <div class="container">
            ...
            <div class="box box-primary" >
                <div class="box-body">
                    ...
                    <div class="text-capitalize bg-dark p-2 shadow mb-3 text-center text-lg text-light rounded" >Add New hod</div>
                    ...
                    <table  class="table table-all table-hover"  style="" id="">
                        ...
                        <tbody>
                            ...
                            @empty
                            <td colspan="3" class="text-warning">No data avaialable</td>
                        </tr>
                            @endforelse
                            </tbody>
                    </table>
