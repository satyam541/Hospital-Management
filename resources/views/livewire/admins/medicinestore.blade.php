        ...
        <div class="container">
            ...
            <div class="box box-primary" >
                <div class="box-body">
                    ...
                    <div class="text-capitalize bg-dark p-2 shadow mb-3 text-center text-lg text-light rounded" >Add New medicine</div>
                    ...
                    <div class="text-capitalize bg-dark p-2 shadow mb-3 text-center text-lg text-light rounded" >All  medicine</div>
                    <table  class="table table-hover"  style="" id="">
                        ...
                        <tbody>
                            ...
                            @empty
                            <td class="text-warning" colspan="6">No Data Available</td>
                        </tr>
                            @endforelse
                            </tbody>
                    </table>
