        ...
        <div class="container">
            ...
            <div class="box box-primary" >
                <div class="box-body">
                    ...
                    <div class="text-capitalize bg-dark p-2 shadow mb-3 text-center text-lg text-light rounded" >Clients Messages</div>
                    <table  class="table table-hover">
                        ...
                        <tbody>
                            ...
                            @empty
                            <td class="text-warning" colspan="6">No Data Avaialable</td>
                        </tr>
                            @endforelse
                            </tbody>
                    </table>
